...
export const _RequiredAppList: ApiProps[] = [
  {
    ...
    variables: addAPI(containerSettings, "api-server", [
      { key: "EMAILHOST", value: "send.nhs.net", type: BuildEnvironmentVariableType.PLAINTEXT },
      { key: "EMAILPORT", value: "587", type: BuildEnvironmentVariableType.PLAINTEXT },
    ]),
  ...
  },
  {
    ...
    variables: addAPI(containerSettings, "cf-api-server", [
      { key: "SITE_URL", value: "crossfilter", type: BuildEnvironmentVariableType.PLAINTEXT },
      { key: "TABLENAME", value: "public.covid_populations", type: BuildEnvironmentVariableType.PLAINTEXT },
    ]),
