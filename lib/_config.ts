...
export const _RequiredAppList: ApiProps[] = [
  {
    ...
    siteSubDomain: "api",
    variables: addAPI(containerSettings, "api-server", [{ key: "SITE_URL", value: "crossfilter." + _MYDOMAIN, type: BuildEnvironmentVariableType.PLAINTEXT }]),
  ...
  },
  {
    ...
    variables: addAPI(containerSettings, "cf-api-server", [
      { key: "SITE_URL", value: "crossfilter." + _MYDOMAIN, type: BuildEnvironmentVariableType.PLAINTEXT },
